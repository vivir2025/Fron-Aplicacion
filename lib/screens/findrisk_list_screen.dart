...
class _FindriskListScreenState extends State<FindriskListScreen> {
          ...
          builder: (context) => AlertDialog(
            content: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text('Sincronizando tests FINDRISK pendientes...'),
              ],
            ),
          ),
        );
      ...
      children: [
        Text(
          ...
          style: GoogleFonts.roboto(
            fontSize: 24,
            fontWeight: FontWeight.bold,
            color: color == Colors.blue ? primaryColor : color,
          ),
        ),
        Text(
          label,
  ...
  Widget _buildTestCard(FindriskTest test) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(
          'Test $displayTestId',
          style: GoogleFonts.roboto(fontWeight: FontWeight.w800, fontSize: 16, color: Colors.black87),
        ),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  void _showEstadisticas() async {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Estadísticas FINDRISK'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
